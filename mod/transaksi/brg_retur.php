...
?>
	...
	<div class="content-header">
		<a href="?mod=brg_retur&act=addbrg_retur" class="blue_solid">Tambah Barang Retur</a>
	</div>
	<?php } ?>
    <br>
...
<form method="post" id="form-transaksi" action="javascript:void(0);">
	<div class="col-md-11">
		<fieldset style="border: 1px solid #c0c0c0; padding: 15px;">
			<legend style="background-color: #c0c0c0; font-size: 11pt; border: none; margin: 5px; padding: 5px; width: auto; ">Transaksi Barang Retur</legend>
		<div class="col-md-4">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#form-transaksi').submit(function(){
			$.post('controllers/trans_produk_retur.php?act=add',$('#form-transaksi').serialize(),function(data){
			alert(data);
