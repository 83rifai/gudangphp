...
/*
$kd_br=mysql_query("SELECT * from td_brg_keluar where id='$_GET[id]'");
$kd_b=mysql_fetch_array($kd_br);
$kd_brg1=$kd_b[];
*/
$brg1=mysql_query("SELECT * from td_brg_keluar where id='$_GET[id]'");
...
$kd_brg=$r['kd_barang']; 
	...
	$brg=mysql_query("SELECT sum(jml_konversi) as jum_konv,kd_barang from td_brg_keluar where kd_barang='$kd_brg' and id='$_GET[id]'");
...
//	echo"SELECT sum(jml_konversi) as jum_konv,kd_barang from td_brg_keluar where kd_barang='$kd_brg' and id='$_GET[id]' <br>"; 	
...
//	echo"Delete from tr_brg_keluar where id='$_GET[id]' <br>";
//	echo"Delete from td_brg_keluar where id='$_GET[id]' <br>";
	//hapus tr_brg_keluar
	$delete=mysql_query("Delete from tr_brg_keluar where id='$_GET[id]'");
	//hapus td_brg_keluar
	$delete=mysql_query("Delete from td_brg_keluar where id='$_GET[id]'");		
